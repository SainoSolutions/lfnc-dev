        ...
        <div className="p-8 pl-10 pr-10" style={{paddingLeft: "6rem", paddingRight: "6rem"}}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            <div className="flex items-start gap-4 bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10 hover:bg-white/10 transition-all duration-300">
              ...
              <div>
                <p className="text-gray-400 text-sm font-semibold uppercase tracking-wide mb-1">Date</p>
            ...
            <div className="flex items-start gap-4 bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10 hover:bg-white/10 transition-all duration-300">
              ...
              <div>
                <p className="text-gray-400 text-sm font-semibold uppercase tracking-wide mb-1">Time</p>
                <p className="text-white font-semibold">{data.time}</p>
              </div>
            </div>

            <div className="flex items-start gap-4 bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10 hover:bg-white/10 transition-all duration-300 md:col-span-2">
              ...
              <div>
                <p className="text-gray-400 text-sm font-semibold uppercase tracking-wide mb-1">Location</p>
            ...
            {data.speaker && (
              <div className="flex items-start gap-4 bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10 hover:bg-white/10 transition-all duration-300 md:col-span-2">
                ...
                <div>
                  <p className="text-gray-400 text-sm font-semibold uppercase tracking-wide mb-1">Speaker</p>
                  <p className="text-white font-semibold">{data.speaker}</p>
                </div>
              </div>
            )}
          </div>
