...
import { FaPlus, FaTimes, FaNewspaper } from 'react-icons/fa';
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <div className={`flex flex-col gap-3 mb-4 transition-all duration-300 ${isOpen ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4 pointer-events-none'}`}>
        {/* News & Updates Button - Added this section */}
        <Link
          to="/news-updates"
      ...
      <button
        ...
        className={`w-14 h-14 bg-gradient-to-r from-red-600 to-purple-700 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 flex items-center justify-center ${isOpen ? 'rotate-45' : 'rotate-0'}`}
      >
